<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\bells\lockedit.html";i:1540546727;s:85:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\template\base.html";i:1540375638;s:96:"D:\phpStudy\PHPTutorial\WWW\jifei\public/../application/admin\view\template\javascript_vars.html";i:1488957233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="teacher_id" class="select-box">
                    ...
                    <option value="<?php echo $vo['id']; ?>" <?php if($data['teacher_id'] == $vo['id']): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <select name="mail_id" class="select-box">
                    ...
                    <option value="<?php echo $vo['id']; ?>/<?php echo $vo['price']; ?>" <?php if($data['mail_id'] == $vo['id']): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div>
                    ...
                    <p style="width:50%;float: left;font-size: 14px"><input name="com_id[]" type="checkbox" <?php if(in_array(($vo['id']), is_array($data['com_id'])?$data['com_id']:explode(',',$data['com_id']))): ?> checked <?php endif; ?>value="<?php echo $vo['id']; ?>/<?php echo $vo['price']; ?>"/><?php echo $vo['name']; ?></p>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <?php echo date('Y-m-d H:i',$data['starttime']); ?>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
